import { NavigationState, Router, DefaultRouterOptions, ParamListBase } from '@react-navigation/routers/lib/typescript/src/types';
...
export default function StackRouter(options: StackRouterOptions): Router<StackNavigationState, {
    ...
    type: "RESET";
    payload: import("@react-navigation/routers/lib/typescript/src/types").PartialState<NavigationState>;
    source?: string | undefined;
    target?: string | undefined;
} | {
    type: "SET_PARAMS";
